	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"media": schema.DynamicAttribute{
				MarkdownDescription: "This attribute defines which media the style should be applied to.",
				Optional:            true,
			},
			"nonce": schema.DynamicAttribute{
				MarkdownDescription: "A cryptographic nonce (number used once) used to allow inline styles in a [style-src Content-Security-Policy](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/style-src).",
				Optional:            true,
			},
			"title": schema.DynamicAttribute{
				MarkdownDescription: "This attribute specifies [alternative style sheet](https://developer.mozilla.org/en-US/docs/Web/CSS/Alternative_style_sheets) sets.",
				Optional:            true,
			},
