	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"disabled": schema.DynamicAttribute{
				MarkdownDescription: "If this Boolean attribute is set, none of the items in this option group is selectable.",
				Optional:            true,
			},
			"label": schema.DynamicAttribute{
				MarkdownDescription: "The name of the group of options, which the browser can use when labeling the options in the user interface.",
				Optional:            true,
			},
