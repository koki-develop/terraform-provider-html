...
var (
	_ resource.Resource = &resource_embed{}
)

func newResource_embed() resource.Resource {
	return &resource_embed{}
}

type resource_embed struct{}

func (r *resource_embed) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_embed"
}

func (r *resource_embed) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "The **`<embed>`** [HTML](https://developer.mozilla.org/en-US/docs/Web/HTML) element embeds external content at the specified point in the document.\n\nFor more information, see the [documentation](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/embed).",
		Attributes: map[string]schema.Attribute{
			...
			"height": schema.DynamicAttribute{
				MarkdownDescription: "The displayed height of the resource, in [CSS pixels](https://drafts.csswg.org/css-values/#px).",
				Optional:            true,
			},
			"src": schema.DynamicAttribute{
				MarkdownDescription: "The URL of the resource being embedded.",
				Optional:            true,
			},
			"type": schema.DynamicAttribute{
				MarkdownDescription: "The [MIME type](https://developer.mozilla.org/en-US/docs/Glossary/MIME_type) to use to select the plug-in to instantiate.",
				Optional:            true,
			},
			"width": schema.DynamicAttribute{
				MarkdownDescription: "The displayed width of the resource, in [CSS pixels](https://drafts.csswg.org/css-values/#px).",
				Optional:            true,
			},
...
type resource_embedModel struct {
...
func (r *resource_embed) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	r.handleRequest(ctx, &req.Plan, &resp.State, &resp.Diagnostics)
}

func (r *resource_embed) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	r.handleRequest(ctx, &req.State, &resp.State, &resp.Diagnostics)
}

func (r *resource_embed) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	r.handleRequest(ctx, &req.Plan, &resp.State, &resp.Diagnostics)
}

func (r *resource_embed) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
}

func (r *resource_embed) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&resource_embedModel{},
		g,
