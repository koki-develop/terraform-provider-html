...
var (
	_ datasource.DataSource = &datasource_br{}
)

func newDatasource_br() datasource.DataSource {
	return &datasource_br{}
}

type datasource_br struct{}

func (d *datasource_br) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_br"
}

func (d *datasource_br) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_brModel struct {
...
func (d *datasource_br) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_br) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_brModel{},
		g,
		s,
		diags,
		func(m *datasource_brModel) bool {
