	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"max": schema.DynamicAttribute{
				MarkdownDescription: "This attribute describes how much work the task indicated by the `progress` element requires.",
				Optional:            true,
			},
			"value": schema.DynamicAttribute{
				MarkdownDescription: "This attribute specifies how much of the task that has been completed.",
				Optional:            true,
			},
