	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"cite": schema.DynamicAttribute{
				MarkdownDescription: "A URI for a resource that explains the change (for example, meeting minutes).",
				Optional:            true,
			},
			"datetime": schema.DynamicAttribute{
				MarkdownDescription: "This attribute indicates the time and date of the change and must be a valid date string with an optional time.",
				Optional:            true,
			},
