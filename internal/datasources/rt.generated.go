...
var (
	_ datasource.DataSource = &datasource_rt{}
)

func newDatasource_rt() datasource.DataSource {
	return &datasource_rt{}
}

type datasource_rt struct{}

func (d *datasource_rt) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_rt"
}

func (d *datasource_rt) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_rtModel struct {
...
func (d *datasource_rt) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_rt) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_rtModel{},
		g,
		s,
		diags,
		func(m *datasource_rtModel) bool {
