...
var (
	_ datasource.DataSource = &datasource_data{}
)

func newDatasource_data() datasource.DataSource {
	return &datasource_data{}
}

type datasource_data struct{}

func (d *datasource_data) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_data"
}

func (d *datasource_data) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_dataModel struct {
...
func (d *datasource_data) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_data) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_dataModel{},
		g,
		s,
		diags,
		func(m *datasource_dataModel) bool {
