...
var (
	_ datasource.DataSource = &datasource_td{}
)

func newDatasource_td() datasource.DataSource {
	return &datasource_td{}
}

type datasource_td struct{}

func (d *datasource_td) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_td"
}

func (d *datasource_td) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_tdModel struct {
...
func (d *datasource_td) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_td) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_tdModel{},
		g,
		s,
		diags,
		func(m *datasource_tdModel) bool {
