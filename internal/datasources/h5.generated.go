...
var (
	_ datasource.DataSource = &datasource_h5{}
)

func newDatasource_h5() datasource.DataSource {
	return &datasource_h5{}
}

type datasource_h5 struct{}

func (d *datasource_h5) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_h5"
}

func (d *datasource_h5) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_h5Model struct {
...
func (d *datasource_h5) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_h5) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_h5Model{},
		g,
		s,
		diags,
		func(m *datasource_h5Model) bool {
