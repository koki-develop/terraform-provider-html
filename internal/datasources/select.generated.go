	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"autocomplete": schema.DynamicAttribute{
				MarkdownDescription: "A string providing a hint for a [user agent's](https://developer.mozilla.org/en-US/docs/Glossary/User_agent) autocomplete feature.",
				Optional:            true,
			},
			...
			"form": schema.DynamicAttribute{
				MarkdownDescription: "The [`<form>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form) element to associate the `<select>` with (its _form owner_).",
				Optional:            true,
			},
			"multiple": schema.DynamicAttribute{
				MarkdownDescription: "This Boolean attribute indicates that multiple options can be selected in the list.",
				Optional:            true,
			},
			"name": schema.DynamicAttribute{
				MarkdownDescription: "This attribute is used to specify the name of the control.",
				Optional:            true,
			},
			"required": schema.DynamicAttribute{
				MarkdownDescription: "A Boolean attribute indicating that an option with a non-empty string value must be selected.",
				Optional:            true,
			},
			"size": schema.DynamicAttribute{
				MarkdownDescription: "If the control is presented as a scrolling list box (e.g. when `multiple` is specified), this attribute represents the number of rows in the list that should be visible at one time.",
				Optional:            true,
			},
