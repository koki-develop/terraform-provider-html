...
var (
	_ datasource.DataSource = &datasource_aside{}
)

func newDatasource_aside() datasource.DataSource {
	return &datasource_aside{}
}

type datasource_aside struct{}

func (d *datasource_aside) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_aside"
}

func (d *datasource_aside) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_asideModel struct {
...
func (d *datasource_aside) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_aside) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_asideModel{},
		g,
		s,
		diags,
		func(m *datasource_asideModel) bool {
