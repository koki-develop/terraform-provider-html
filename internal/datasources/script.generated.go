...
var (
	_ datasource.DataSource = &datasource_script{}
)

func newDatasource_script() datasource.DataSource {
	return &datasource_script{}
}

type datasource_script struct{}

func (d *datasource_script) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_script"
}

func (d *datasource_script) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_scriptModel struct {
...
func (d *datasource_script) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_script) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_scriptModel{},
		g,
		s,
		diags,
		func(m *datasource_scriptModel) bool {
