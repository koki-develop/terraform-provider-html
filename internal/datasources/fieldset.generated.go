	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"disabled": schema.DynamicAttribute{
				MarkdownDescription: "If this Boolean attribute is set, all form controls that are descendants of the `<fieldset>`, are disabled, meaning they are not editable and won't be submitted along with the [`<form>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form).",
				Optional:            true,
			},
			"form": schema.DynamicAttribute{
				MarkdownDescription: "This attribute takes the value of the [`id`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#id) attribute of a [`<form>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form) element you want the `<fieldset>` to be part of, even if it is not inside the form.",
				Optional:            true,
			},
			"name": schema.DynamicAttribute{
				MarkdownDescription: "The name associated with the group.",
				Optional:            true,
			},
