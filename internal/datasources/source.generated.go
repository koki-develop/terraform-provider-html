	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"type": schema.DynamicAttribute{
				MarkdownDescription: "Specifies the [MIME media type of the image](https://developer.mozilla.org/en-US/docs/Web/Media/Formats/Image_types) or [other media type](https://developer.mozilla.org/en-US/docs/Web/Media/Formats/Containers), optionally including a [`codecs` parameter](https://developer.mozilla.org/en-US/docs/Web/Media/Formats/codecs_parameter).",
				Optional:            true,
			},
			"src": schema.DynamicAttribute{
				MarkdownDescription: "Specifies the URL of the media resource.",
				Optional:            true,
			},
			"srcset": schema.DynamicAttribute{
				MarkdownDescription: "Specifies a comma-separated list of one or more image URLs and their descriptors.",
				Optional:            true,
			},
			"sizes": schema.DynamicAttribute{
				MarkdownDescription: "Specifies a list of source sizes that describe the final rendered width of the image.",
				Optional:            true,
			},
			"media": schema.DynamicAttribute{
				MarkdownDescription: "Specifies the [media query](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_media_queries) for the resource's intended media.",
				Optional:            true,
			},
			"height": schema.DynamicAttribute{
				MarkdownDescription: "Specifies the intrinsic height of the image in pixels.",
				Optional:            true,
			},
			"width": schema.DynamicAttribute{
				MarkdownDescription: "Specifies the intrinsic width of the image in pixels.",
				Optional:            true,
			},
