...
var (
	_ datasource.DataSource = &datasource_img{}
)

func newDatasource_img() datasource.DataSource {
	return &datasource_img{}
}

type datasource_img struct{}

func (d *datasource_img) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_img"
}

func (d *datasource_img) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_imgModel struct {
...
func (d *datasource_img) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_img) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_imgModel{},
		g,
		s,
		diags,
		func(m *datasource_imgModel) bool {
