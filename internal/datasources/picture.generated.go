...
var (
	_ datasource.DataSource = &datasource_picture{}
)

func newDatasource_picture() datasource.DataSource {
	return &datasource_picture{}
}

type datasource_picture struct{}

func (d *datasource_picture) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_picture"
}

func (d *datasource_picture) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_pictureModel struct {
...
func (d *datasource_picture) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_picture) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_pictureModel{},
		g,
		s,
		diags,
		func(m *datasource_pictureModel) bool {
...
func init() {
	register(newDatasource_picture)
}
