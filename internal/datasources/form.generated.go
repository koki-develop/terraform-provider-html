...
var (
	_ datasource.DataSource = &datasource_form{}
)

func newDatasource_form() datasource.DataSource {
	return &datasource_form{}
}

type datasource_form struct{}

func (d *datasource_form) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_form"
}

func (d *datasource_form) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_formModel struct {
...
func (d *datasource_form) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_form) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_formModel{},
		g,
		s,
		diags,
		func(m *datasource_formModel) bool {
