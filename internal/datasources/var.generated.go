...
var (
	_ datasource.DataSource = &datasource_var{}
)

func newDatasource_var() datasource.DataSource {
	return &datasource_var{}
}

type datasource_var struct{}

func (d *datasource_var) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_var"
}

func (d *datasource_var) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_varModel struct {
...
func (d *datasource_var) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_var) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_varModel{},
		g,
		s,
		diags,
		func(m *datasource_varModel) bool {
