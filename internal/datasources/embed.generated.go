...
var (
	_ datasource.DataSource = &datasource_embed{}
)

func newDatasource_embed() datasource.DataSource {
	return &datasource_embed{}
}

type datasource_embed struct{}

func (d *datasource_embed) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_embed"
}

func (d *datasource_embed) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_embedModel struct {
...
func (d *datasource_embed) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_embed) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_embedModel{},
		g,
		s,
		diags,
		func(m *datasource_embedModel) bool {
