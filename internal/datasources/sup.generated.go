...
var (
	_ datasource.DataSource = &datasource_sup{}
)

func newDatasource_sup() datasource.DataSource {
	return &datasource_sup{}
}

type datasource_sup struct{}

func (d *datasource_sup) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sup"
}

func (d *datasource_sup) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_supModel struct {
...
func (d *datasource_sup) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_sup) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_supModel{},
		g,
		s,
		diags,
		func(m *datasource_supModel) bool {
