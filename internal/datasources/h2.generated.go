...
var (
	_ datasource.DataSource = &datasource_h2{}
)

func newDatasource_h2() datasource.DataSource {
	return &datasource_h2{}
}

type datasource_h2 struct{}

func (d *datasource_h2) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_h2"
}

func (d *datasource_h2) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_h2Model struct {
...
func (d *datasource_h2) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_h2) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_h2Model{},
		g,
		s,
		diags,
		func(m *datasource_h2Model) bool {
