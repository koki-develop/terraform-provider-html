...
var (
	_ datasource.DataSource = &datasource_small{}
)

func newDatasource_small() datasource.DataSource {
	return &datasource_small{}
}

type datasource_small struct{}

func (d *datasource_small) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_small"
}

func (d *datasource_small) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_smallModel struct {
...
func (d *datasource_small) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_small) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_smallModel{},
		g,
		s,
		diags,
		func(m *datasource_smallModel) bool {
