...
func (d *datasource_input) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"accept": schema.DynamicAttribute{
				MarkdownDescription: "Hint for expected file type in file upload controls.",
				Optional:            true,
			},
			"alt": schema.DynamicAttribute{
				MarkdownDescription: "alt attribute for the image type.",
				Optional:            true,
			},
			"autocapitalize": schema.DynamicAttribute{
				MarkdownDescription: "Controls automatic capitalization in inputted text.",
				Optional:            true,
			},
			"autocomplete": schema.DynamicAttribute{
				MarkdownDescription: "Hint for form autofill feature.",
				Optional:            true,
			},
			"capture": schema.DynamicAttribute{
				MarkdownDescription: "Media capture input method in file upload controls.",
				Optional:            true,
			},
			"checked": schema.DynamicAttribute{
				MarkdownDescription: "Whether the command or control is checked.",
				Optional:            true,
			},
			"dirname": schema.DynamicAttribute{
				MarkdownDescription: "Name of form field to use for sending the element's directionality in form submission.",
				Optional:            true,
			},
			"disabled": schema.DynamicAttribute{
				MarkdownDescription: "Whether the form control is disabled.",
				Optional:            true,
			},
			"form": schema.DynamicAttribute{
				MarkdownDescription: "Associates the control with a form element.",
				Optional:            true,
			},
			"formaction": schema.DynamicAttribute{
				MarkdownDescription: "URL to use for form submission.",
				Optional:            true,
			},
			"formenctype": schema.DynamicAttribute{
				MarkdownDescription: "Form data set encoding type to use for form submission.",
				Optional:            true,
			},
			"formmethod": schema.DynamicAttribute{
				MarkdownDescription: "HTTP method to use for form submission.",
				Optional:            true,
			},
			"formnovalidate": schema.DynamicAttribute{
				MarkdownDescription: "Bypass form control validation for form submission.",
				Optional:            true,
			},
			"formtarget": schema.DynamicAttribute{
				MarkdownDescription: "Browsing context for form submission.",
				Optional:            true,
			},
			"height": schema.DynamicAttribute{
				MarkdownDescription: "Same as height attribute for [`<img>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img).",
				Optional:            true,
			},
			"list": schema.DynamicAttribute{
				MarkdownDescription: "Value of the id attribute of the [`<datalist>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/datalist) of autocomplete options.",
				Optional:            true,
			},
			"max": schema.DynamicAttribute{
				MarkdownDescription: "Maximum value.",
				Optional:            true,
			},
			"maxlength": schema.DynamicAttribute{
				MarkdownDescription: "Maximum length (number of characters) of `value`.",
				Optional:            true,
			},
			"min": schema.DynamicAttribute{
				MarkdownDescription: "Minimum value.",
				Optional:            true,
			},
			"minlength": schema.DynamicAttribute{
				MarkdownDescription: "Minimum length (number of characters) of `value`.",
				Optional:            true,
			},
			"multiple": schema.DynamicAttribute{
				MarkdownDescription: "Whether to allow multiple values.",
				Optional:            true,
			},
			"name": schema.DynamicAttribute{
				MarkdownDescription: "Name of the form control.",
				Optional:            true,
			},
			"pattern": schema.DynamicAttribute{
				MarkdownDescription: "Pattern the `value` must match to be valid.",
				Optional:            true,
			},
			"placeholder": schema.DynamicAttribute{
				MarkdownDescription: "Text that appears in the form control when it has no value set.",
				Optional:            true,
			},
			"popovertarget": schema.DynamicAttribute{
				MarkdownDescription: "Designates an `<input type=\"button\">` as a control for a popover element.",
				Optional:            true,
			},
			"popovertargetaction": schema.DynamicAttribute{
				MarkdownDescription: "Specifies the action that a popover control should perform.",
				Optional:            true,
			},
			"readonly": schema.DynamicAttribute{
				MarkdownDescription: "The value is not editable.",
				Optional:            true,
			},
			"required": schema.DynamicAttribute{
				MarkdownDescription: "A value is required or must be checked for the form to be submittable.",
				Optional:            true,
			},
			"size": schema.DynamicAttribute{
				MarkdownDescription: "Size of the control.",
				Optional:            true,
			},
			"src": schema.DynamicAttribute{
				MarkdownDescription: "Same as `src` attribute for [`<img>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img).",
				Optional:            true,
			},
			"step": schema.DynamicAttribute{
				MarkdownDescription: "Incremental values that are valid.",
				Optional:            true,
			},
			"type": schema.DynamicAttribute{
				MarkdownDescription: "Type of form control.",
				Optional:            true,
			},
			"value": schema.DynamicAttribute{
				MarkdownDescription: "The value of the control.",
				Optional:            true,
			},
			"width": schema.DynamicAttribute{
				MarkdownDescription: "Same as `width` attribute for [`<img>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img).",
				Optional:            true,
			},
...
type datasource_inputModel struct {
	...
	Capture             types.Dynamic `tfsdk:"capture"`
	Checked             types.Dynamic `tfsdk:"checked"`
	Dirname             types.Dynamic `tfsdk:"dirname"`
	...
	Maxlength           types.Dynamic `tfsdk:"maxlength"`
	Min                 types.Dynamic `tfsdk:"min"`
	Minlength           types.Dynamic `tfsdk:"minlength"`
	Multiple            types.Dynamic `tfsdk:"multiple"`
	Name                types.Dynamic `tfsdk:"name"`
	Pattern             types.Dynamic `tfsdk:"pattern"`
	Placeholder         types.Dynamic `tfsdk:"placeholder"`
	Popovertarget       types.Dynamic `tfsdk:"popovertarget"`
	Popovertargetaction types.Dynamic `tfsdk:"popovertargetaction"`
	Readonly            types.Dynamic `tfsdk:"readonly"`
	Required            types.Dynamic `tfsdk:"required"`
	Size                types.Dynamic `tfsdk:"size"`
	Src                 types.Dynamic `tfsdk:"src"`
	Step                types.Dynamic `tfsdk:"step"`
...
func (d *datasource_input) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		...
		func(m *datasource_inputModel) bool {
			...
			attrs := []string{}
			if !m.Accept.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "accept", m.Accept)
				if err != nil {
					diags.AddError("invalid accept attribute", err.Error())
					return false
				}
			...
			if !m.Autocomplete.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "autocomplete", m.Autocomplete)
				if err != nil {
					diags.AddError("invalid autocomplete attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			if !m.Capture.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "capture", m.Capture)
				if err != nil {
					diags.AddError("invalid capture attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			if !m.Checked.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "checked", m.Checked)
				if err != nil {
					diags.AddError("invalid checked attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			if !m.Dirname.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "dirname", m.Dirname)
				if err != nil {
					diags.AddError("invalid dirname attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			...
			if !m.List.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "list", m.List)
				if err != nil {
					diags.AddError("invalid list attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			if !m.Max.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "max", m.Max)
				if err != nil {
					diags.AddError("invalid max attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			if !m.Maxlength.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "maxlength", m.Maxlength)
				if err != nil {
					diags.AddError("invalid maxlength attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			if !m.Min.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "min", m.Min)
				if err != nil {
					diags.AddError("invalid min attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			if !m.Minlength.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "minlength", m.Minlength)
				if err != nil {
					diags.AddError("invalid minlength attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			if !m.Multiple.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "multiple", m.Multiple)
				if err != nil {
					diags.AddError("invalid multiple attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			...
			if !m.Pattern.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "pattern", m.Pattern)
				if err != nil {
					diags.AddError("invalid pattern attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			if !m.Placeholder.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "placeholder", m.Placeholder)
				if err != nil {
					diags.AddError("invalid placeholder attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			...
			if !m.Readonly.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "readonly", m.Readonly)
				if err != nil {
					diags.AddError("invalid readonly attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			if !m.Required.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "required", m.Required)
				if err != nil {
					diags.AddError("invalid required attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			if !m.Size.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "size", m.Size)
				if err != nil {
					diags.AddError("invalid size attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
			...
			if !m.Step.IsNull() {
				attr, err := util.StringifyAttribute(ctx, "step", m.Step)
				if err != nil {
					diags.AddError("invalid step attribute", err.Error())
					return false
				}
				attrs = append(attrs, attr)
			}
