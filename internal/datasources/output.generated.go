...
var (
	_ datasource.DataSource = &datasource_output{}
)

func newDatasource_output() datasource.DataSource {
	return &datasource_output{}
}

type datasource_output struct{}

func (d *datasource_output) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_output"
}

func (d *datasource_output) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_outputModel struct {
...
func (d *datasource_output) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_output) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_outputModel{},
		g,
		s,
		diags,
		func(m *datasource_outputModel) bool {
