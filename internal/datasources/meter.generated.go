...
var (
	_ datasource.DataSource = &datasource_meter{}
)

func newDatasource_meter() datasource.DataSource {
	return &datasource_meter{}
}

type datasource_meter struct{}

func (d *datasource_meter) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_meter"
}

func (d *datasource_meter) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_meterModel struct {
...
func (d *datasource_meter) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_meter) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_meterModel{},
		g,
		s,
		diags,
		func(m *datasource_meterModel) bool {
