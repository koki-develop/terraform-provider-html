...
var (
	_ datasource.DataSource = &datasource_body{}
)

func newDatasource_body() datasource.DataSource {
	return &datasource_body{}
}

type datasource_body struct{}

func (d *datasource_body) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_body"
}

func (d *datasource_body) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_bodyModel struct {
...
func (d *datasource_body) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_body) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_bodyModel{},
		g,
		s,
		diags,
		func(m *datasource_bodyModel) bool {
