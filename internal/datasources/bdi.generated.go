...
var (
	_ datasource.DataSource = &datasource_bdi{}
)

func newDatasource_bdi() datasource.DataSource {
	return &datasource_bdi{}
}

type datasource_bdi struct{}

func (d *datasource_bdi) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_bdi"
}

func (d *datasource_bdi) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_bdiModel struct {
...
func (d *datasource_bdi) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_bdi) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_bdiModel{},
		g,
		s,
		diags,
		func(m *datasource_bdiModel) bool {
