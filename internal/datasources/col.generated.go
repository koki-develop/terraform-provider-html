...
var (
	_ datasource.DataSource = &datasource_col{}
)

func newDatasource_col() datasource.DataSource {
	return &datasource_col{}
}

type datasource_col struct{}

func (d *datasource_col) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_col"
}

func (d *datasource_col) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_colModel struct {
...
func (d *datasource_col) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_col) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_colModel{},
		g,
		s,
		diags,
		func(m *datasource_colModel) bool {
