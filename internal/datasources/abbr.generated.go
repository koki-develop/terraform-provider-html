...
var (
	_ datasource.DataSource = &datasource_abbr{}
)

func newDatasource_abbr() datasource.DataSource {
	return &datasource_abbr{}
}

type datasource_abbr struct{}

func (d *datasource_abbr) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
type datasource_abbrModel struct {
...
func (d *datasource_abbr) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_abbr) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_abbrModel{},
		g,
		s,
		diags,
		func(m *datasource_abbrModel) bool {
