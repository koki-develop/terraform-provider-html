...
var (
	_ datasource.DataSource = &datasource_h4{}
)

func newDatasource_h4() datasource.DataSource {
	return &datasource_h4{}
}

type datasource_h4 struct{}

func (d *datasource_h4) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_h4"
}

func (d *datasource_h4) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_h4Model struct {
...
func (d *datasource_h4) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_h4) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_h4Model{},
		g,
		s,
		diags,
		func(m *datasource_h4Model) bool {
