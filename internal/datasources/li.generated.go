...
var (
	_ datasource.DataSource = &datasource_li{}
)

func newDatasource_li() datasource.DataSource {
	return &datasource_li{}
}

type datasource_li struct{}

func (d *datasource_li) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_li"
}

func (d *datasource_li) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_liModel struct {
...
func (d *datasource_li) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_li) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_liModel{},
		g,
		s,
		diags,
		func(m *datasource_liModel) bool {
