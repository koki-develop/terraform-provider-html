...
var (
	_ datasource.DataSource = &datasource_header{}
)

func newDatasource_header() datasource.DataSource {
	return &datasource_header{}
}

type datasource_header struct{}

func (d *datasource_header) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_header"
}

func (d *datasource_header) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_headerModel struct {
...
func (d *datasource_header) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_header) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_headerModel{},
		g,
		s,
		diags,
		func(m *datasource_headerModel) bool {
