...
var (
	_ datasource.DataSource = &datasource_article{}
)

func newDatasource_article() datasource.DataSource {
	return &datasource_article{}
}

type datasource_article struct{}

func (d *datasource_article) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_article"
}

func (d *datasource_article) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_articleModel struct {
...
func (d *datasource_article) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_article) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_articleModel{},
		g,
		s,
		diags,
		func(m *datasource_articleModel) bool {
...
func init() {
	register(newDatasource_article)
}
