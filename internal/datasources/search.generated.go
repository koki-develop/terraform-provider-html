...
var (
	_ datasource.DataSource = &datasource_search{}
)

func newDatasource_search() datasource.DataSource {
	return &datasource_search{}
}

type datasource_search struct{}

func (d *datasource_search) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_search"
}

func (d *datasource_search) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_searchModel struct {
...
func (d *datasource_search) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_search) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_searchModel{},
		g,
		s,
		diags,
		func(m *datasource_searchModel) bool {
