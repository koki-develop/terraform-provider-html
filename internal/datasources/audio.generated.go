...
var (
	_ datasource.DataSource = &datasource_audio{}
)

func newDatasource_audio() datasource.DataSource {
	return &datasource_audio{}
}

type datasource_audio struct{}

func (d *datasource_audio) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_audio"
}

func (d *datasource_audio) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_audioModel struct {
...
func (d *datasource_audio) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_audio) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_audioModel{},
		g,
		s,
		diags,
		func(m *datasource_audioModel) bool {
