...
var (
	_ datasource.DataSource = &datasource_ul{}
)

func newDatasource_ul() datasource.DataSource {
	return &datasource_ul{}
}

type datasource_ul struct{}

func (d *datasource_ul) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ul"
}

func (d *datasource_ul) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_ulModel struct {
...
func (d *datasource_ul) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_ul) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_ulModel{},
		g,
		s,
		diags,
		func(m *datasource_ulModel) bool {
