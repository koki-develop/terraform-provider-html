...
var (
	_ datasource.DataSource = &datasource_section{}
)

func newDatasource_section() datasource.DataSource {
	return &datasource_section{}
}

type datasource_section struct{}

func (d *datasource_section) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_section"
}

func (d *datasource_section) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_sectionModel struct {
...
func (d *datasource_section) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_section) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_sectionModel{},
		g,
		s,
		diags,
		func(m *datasource_sectionModel) bool {
...
func init() {
	register(newDatasource_section)
}
