...
var (
	_ datasource.DataSource = &datasource_h1{}
)

func newDatasource_h1() datasource.DataSource {
	return &datasource_h1{}
}

type datasource_h1 struct{}

func (d *datasource_h1) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_h1"
}

func (d *datasource_h1) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_h1Model struct {
...
func (d *datasource_h1) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_h1) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_h1Model{},
		g,
		s,
		diags,
		func(m *datasource_h1Model) bool {
