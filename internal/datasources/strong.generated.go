...
var (
	_ datasource.DataSource = &datasource_strong{}
)

func newDatasource_strong() datasource.DataSource {
	return &datasource_strong{}
}

type datasource_strong struct{}

func (d *datasource_strong) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_strong"
}

func (d *datasource_strong) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_strongModel struct {
...
func (d *datasource_strong) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_strong) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_strongModel{},
		g,
		s,
		diags,
		func(m *datasource_strongModel) bool {
