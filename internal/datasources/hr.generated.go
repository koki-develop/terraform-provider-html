...
var (
	_ datasource.DataSource = &datasource_hr{}
)

func newDatasource_hr() datasource.DataSource {
	return &datasource_hr{}
}

type datasource_hr struct{}

func (d *datasource_hr) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_hr"
}

func (d *datasource_hr) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_hrModel struct {
...
func (d *datasource_hr) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_hr) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_hrModel{},
		g,
		s,
		diags,
		func(m *datasource_hrModel) bool {
