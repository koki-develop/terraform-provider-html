...
var (
	_ datasource.DataSource = &datasource_h6{}
)

func newDatasource_h6() datasource.DataSource {
	return &datasource_h6{}
}

type datasource_h6 struct{}

func (d *datasource_h6) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_h6"
}

func (d *datasource_h6) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_h6Model struct {
...
func (d *datasource_h6) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_h6) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_h6Model{},
		g,
		s,
		diags,
		func(m *datasource_h6Model) bool {
