...
var (
	_ datasource.DataSource = &datasource_em{}
)

func newDatasource_em() datasource.DataSource {
	return &datasource_em{}
}

type datasource_em struct{}

func (d *datasource_em) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_em"
}

func (d *datasource_em) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_emModel struct {
...
func (d *datasource_em) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_em) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_emModel{},
		g,
		s,
		diags,
		func(m *datasource_emModel) bool {
