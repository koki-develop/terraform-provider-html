...
var (
	_ datasource.DataSource = &datasource_h3{}
)

func newDatasource_h3() datasource.DataSource {
	return &datasource_h3{}
}

type datasource_h3 struct{}

func (d *datasource_h3) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_h3"
}

func (d *datasource_h3) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
type datasource_h3Model struct {
...
func (d *datasource_h3) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	d.handleRequest(ctx, &req.Config, &resp.State, &resp.Diagnostics)
}

func (d *datasource_h3) handleRequest(ctx context.Context, g util.ModelGetter, s util.ModelSetter, diags *diag.Diagnostics) {
	util.HandleRequest(
		ctx,
		&datasource_h3Model{},
		g,
		s,
		diags,
		func(m *datasource_h3Model) bool {
